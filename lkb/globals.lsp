...
(defparameter *maximum-number-of-edges* 100000000)
...
;;;
;;; when running as part of the LOGON tree, users need not have their own local
;;; installation of FreeLing, and we avoid all usages of absolute path names.
;;; thus, ideally, the complete LOGON tree, including the SRG and FreeLing, can
;;; be run on any (reasonably up-to-date) Linux installation, without the need
;;; to install additional, non-standard packages.              (20-sep-07; oe)
;;;
(setf *sppp-application* 
  ...
  #-:logon
  "/home/montse/freeling/sppp")

#+:logon
(setf *sppp-coding-system* :utf-8)
;;;(setf *sppp-coding-system* :iso-8859-1)
